...
import {
  LayoutDashboard, MessageSquare, Upload, Database,
  LogOut, ChevronLeft, ChevronRight, Menu, X, User
} from 'lucide-react'
import { useAuthStore, useDatasetStore } from '../../store'
  ...
  return (
    <>
      ...
      <div className="mobile-header" style={{
        ...
        <div style={{ fontWeight: 700, fontSize: 15 }} className="text-gradient">DataMind AI</div>
      ...
      <div
        ...
        style={{ width: collapsed ? 60 : 260, transition: 'width 0.25s ease, transform 0.25s ease' }}
      >
        {/* Brand */}
                ...
                <Trash2
                  ...
                  onClick={async (e) => {
                    ...
                    try {
                      ...
                      const { removeDataset } = useDatasetStore.getState()
      ...
      <div className="mobile-bottom-nav">
        <div className="mobile-bottom-nav-inner">
          ...
          {user ? (
            ...
            <button className={`mobile-nav-btn`} onClick={() => navigate('/auth')}>
              <User size={22} />
              <span>Login</span>
            </button>
          )}
